...
(function () {
    ...
    if (h > w) {
        ...
        h = w;
        w = nh;
        mainContainer.style.transform = "translateX(" + (h) + "px) rotate(90deg)";
    }
    ...
    function loadGame() {
        ...
        //tree
        class TreeBuilder {
            constructor(src, src2, start, left) {
